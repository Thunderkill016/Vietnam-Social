...
reset role;
insert into public.places(id,city_id,name,area,longitude,latitude,h3_parent) values('10000000-0000-4000-8000-000000000099','hcm','Outside pilot fixture','Outside',107,11,'8665b2d6fffffff');
set local role authenticated;
set local request.jwt.claim.sub='20000000-0000-4000-8000-000000000001';
select throws_ok($$select public.publish_signal(pg_temp.input() || jsonb_build_object('request_id',gen_random_uuid(),'place_id','10000000-0000-4000-8000-000000000099'))$$,'VS005','venue outside pilot','PostGIS rejects a catalog venue outside pilot');
